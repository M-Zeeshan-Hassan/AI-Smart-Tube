  ...
  const features = [
    {
      ...
      description:
        "Get AI-powered insights on Shorts vs long-form content, fine-tune your strategy, and take your YouTube channel growth to the next level.",
        ...
        <section className="container mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/70 mb-10 leading-relaxed max-w-3xl mx-auto">
              Get AI-powered insights on Shorts vs long-form content, fine-tune
              your strategy, and take your YouTube channel growth to the next
              level.
            </p>
        ...
        <section className="container mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-xl text-white/60">
              See what successful YouTube creators are saying about Smart AI
              Tube
            </p>
          </motion.div>
